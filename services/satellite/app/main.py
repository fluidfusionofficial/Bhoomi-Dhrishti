"""
satellite service � FastAPI application.

Satellite watch service: NDVI/NDBI land-use change detection using Sentinel-2 and Cartosat imagery
"""
...
from app.routers import health, satellite
